...
const Navbar = ({items}: NavbarProps) => {
    return (
        <nav className="fixed top-0 left-0 right-0 z-30 h-[45px] w-full flex justify-between items-center pl-2.5 pr-3 backdrop-blur-md border-b border-neutral-500/50">
            ...
            <Link2 target="_blank" href="https://github.com/nillpoe/nillpoe.xyz" className="flex items-center gap-x-1.5 py-1.5 px-1 rounded-sm hover:bg-foreground/20 transition-colors">
