        ...
        >
            ...
            >
                ...
                <h1 className="text-5xl max-sm:text-4xl font-bold">
                    대한민국 최고의
                    <br/>
                    <span className="text-[#ffcc00]">플러그인</span> 개발팀
                </h1>
                ...
                <div className="flex max-sm:flex-col justify-center gap-4 mt-8">
                    <Link 
                        href="/starly/archive"
                        className="max-sm:w-full justify-center px-6 py-3 bg-starly hover:bg-[#e6b800] hover:text-black text-black rounded-lg transition-colors"
                    >
                        💽 스탈리 아카이브
                    </Link>
                    <Link 
                        href="https://discord.gg/TF8jqSJjCG"
                        className="max-sm:w-full justify-center px-6 py-3 bg-discord hover:bg-discord/80 hover:text-neutral-100/85 text-white rounded-lg transition-colors"
                    >
